...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="php/product.php">Article</a></li>
    ...
    <div class="top-search">
        <div class="container">
            <div class="input-group">
               <form action="php/rechercher_article.php" method="get">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="php/login.php">Commencez une vente </a></p>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <?php while ($articles = $ide->fetch()){
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                        <div class="why-text">
                            <h3><img src="php/views/upload/<?php echo $user['image']; ?>" class="rounded-circle" width="50px" height=auto /></i> <?=$user['username']?></h3>
                    ...
                    <div class="products-single fix">
                        ...
                        <a href="php/info_article.php?id_article=<?= $articles['id_article']?>"> <?php  echo "<img src='http://localhost/FREESHOPPING/assets/images/".$image['img1']."'  class='img-fluid'>"; ?></a>
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="php/info_article_user.php?id_article=<?=$articles['id_article']?>" data-toggle="tooltip" data-placement="right" title="Voir"><i class="fas fa-eye"></i></a></li>
            ...
            <?php while ($articles = $ide->fetch()){
                ...
                <?php
                    ...
                    <div class="product-item">
                        <a href="php/info_article_user.php?id_article=<?= $articles['id_article']?>"> <?php  echo "<img src='http://localhost/vintage/assets/images/".$image['img1']."'  class='img-fluid'>"; ?></a>
