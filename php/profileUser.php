            ...
            <div class="card o-hidden border-0 shadow-lg my-5">
                <div class="card-body p-0">
                    ...
                    <div class="row" >
                        ...
                        <p> <img src="views/upload/<?php echo $users['image']; ?>" class="img-rounded" width="600px" height=auto /></p>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <a class="btn btn-secondary" href="message.php?id=<?=$idUser?>">Envoyer un message</a>
                                      </div>
