...
<body>
   ...
   <div class="main-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p><a class="btn hvr-hover" href="femme.php">Articles classés par genre</a></p>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <?php 
    $second = $connexion->query('SELECT * FROM article Where id_type=1 ORDER BY  id_article desc ');
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                    ...
                    <div class="products-single fix">
                        ...
                        <a href="php/info_article.php?id_article=<?= $articles['id_article']?>"> <?php  echo "<img src='http://localhost/FREESHOPPING/assets/images/".$image['img1']."'  class='img-fluid'>"; ?></a>
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="info_article_user.php" data-toggle="tooltip" data-placement="right" title="Voir"><i class="fas fa-eye"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="why-text">
                ...
                <div class="col-lg-3 col-md-6 special-grid top-featured">
                    ...
                    <div class="products-single fix">
                        ...
                        <a href="php/info_article.php?id_article=<?= $articles['id_article']?>"> <?php  echo "<img src='http://localhost/FREESHOPPING/assets/images/".$image['img1']."'  class='img-fluid'>"; ?></a>
                            ...
                            <div class="mask-icon">
                                <ul>
                                    <li><a href="info_article_user.php?id_article=<?=$articles['id_article']?>" data-toggle="tooltip" data-placement="right" title="Voir"><i class="fas fa-eye"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="why-text">
...
<?php 
$four = $connexion->query('SELECT * FROM article Where id_type=4 ORDER BY  id_article desc ');
