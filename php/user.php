...
?>
<?php
    $sql='SELECT DISTINCT `idEnvoyeur` FROM `message` WHERE `idRecepteur`=:id';
...
?>
<?php
    $sql='SELECT COUNT(*) AS nb FROM `message` WHERE `idRecepteur`=:id';
    $query=$connexion->prepare($sql);
    $query->bindValue(':id', $_SESSION['id']);
    $query->execute();
    $message=$query->fetch();
...
<?php
    $sql='SELECT * FROM `message` WHERE `idRecepteur`=:id';
    $query=$connexion->prepare($sql);
    $query->bindValue(':id', $_SESSION['id']);
    $query->execute();
    $message=$query->fetchAll();
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="user.php">Accueil</a></li>
                        ...
                        <li class="search"><a href="#"><i class="fa fa-search"></i></a></li>
                            ...
                            <li class="dropdown ">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="dashboard.php"><?=$messages['idEnvoyeur']?></a></li>
                                   <?php }?>
                                </ul>
                            </li>
