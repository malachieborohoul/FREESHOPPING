    ...
    if (isset($_SESSION['username']) && isset($_SESSION['id']))

        {
            ...
            if(isset($_POST['btnsave']))
            {
                ...
                {
                    $stmt = $connexion->prepare('UPDATE users SET username=:username, email=:email, password=:password, image=:image WHERE id=:id');
                        ...
                        <div class="card o-hidden border-0 shadow-lg my-5">
                            <div class="card-body p-0">
                                ...
                                <div class="row" >
                                    ...
                                    <img src="views/upload/<?=$edit_row['image']?>" class="img-rounded" width=auto height="400px" />
