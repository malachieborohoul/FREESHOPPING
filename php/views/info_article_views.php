...
<table>
    ...
    <br>
            ...
            $image = $images->fetch();
            if (!empty($image['img1']))
                echo "<img width='150' height='200' src='http://localhost/vintage/assets/images/".$image['img1']."'>";
            if (!empty($image['img2']))
                echo "<img width='150' height='300' src='http://localhost/vintage/assets/images/".$image['img2']."'>";
            if (!empty($image['img3']))
                echo "<img width='150' height='300' src='http://localhost/vintage/assets/images/".$image['img3']."'>";
            if (!empty($image['img4']))
                echo "<img width='150' height='300' src='http://localhost/vintage/assets/images/".$image['img4']."'>";
            ?>
